...
**Tests**: Tests are MANDATORY and test-first (Constitution Principle IV: Test-First, No Exceptions). Every user story phase MUST include test tasks, written and observed failing before implementation tasks begin.
